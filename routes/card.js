...
Router.get('/purchaseUltimusPack', async (request, response) => {
	...
	try {
		...
		for (const chance of cardChances) {
			if (chance > 0 && chance <= 3656) { // 3656
				cardRarity = 'Backup';
			} else if (chance > 3656 && chance <= 5918) { // 2262
				cardRarity = 'Starter';
			} else if (chance > 5918 && chance <= 7558) { // 1640
				cardRarity = 'Star';
			} else if (chance > 7558 && chance <= 8671) { // 1113
				cardRarity = 'All-Pro';
			} else if (chance > 8671 && chance <= 8851) { // 180
				cardRarity = 'Legend';
			} else if (chance > 8851 && chance <= 9004) { // 153
				cardRarity = 'Award';
			} else if (chance > 9004 && chance <= 9023) { // 19
				cardRarity = 'Hall of Fame';
			} else if (chance > 9023 && chance <= 9422) { // 399
				cardRarity = 'Ultimus Champion';
			} else if (chance > 9422 && chance <= 9530) { // 108
				cardRarity = 'Holograph Expansion'
			} else if (chance > 9530 && chance <= 9660) { // 130
				cardRarity = 'Autograph Rookie';
			} else if (chance > 9660 && chance <= 9720) { // 60
				cardRarity = 'Fantasy Kings';
			} else if (chance > 9720 && chance <= 10000) { // 280
				cardRarity = 'Captain';
			} else {
				cardRarity = 'Backup';
			}
